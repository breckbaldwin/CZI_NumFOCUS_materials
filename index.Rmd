...
The query being run below is 'jupyter'
...
pkg_query <- c(query,  # sets the query
               '',
               '')
...
write.csv(scopus.df, file=paste("scopus_data/", query, ".csv", sep = ""), row.names = FALSE) 
write.csv(df_long, file=paste("scopus_data/", query, "_long.csv", sep = ""), row.names = FALSE) 
