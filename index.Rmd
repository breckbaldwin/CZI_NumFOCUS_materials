...
I have spent a ton of time doing metrics in support of open source scientific software, Stan in particular, and I'd like to see them used more broadly if it helps people write better proposals. The current proposal that lots of NumFOCUS projects are applying for is the Chan Zuckerberg Initiative (CZI) [https://chanzuckerberg.com/wp-content/uploads/2021/03/EOSS-4-Combined-RFA-Packet.pdf](https://chanzuckerberg.com/wp-content/uploads/2021/03/EOSS-4-Combined-RFA-Packet.pdf).

The NumFOCUS community recently submitted a bunch of proposal to NASA's open source infrastructure call for proposals and Stan joined up with PyMC and ArviZ since we all play in the Bayesian space. I also didn't want to get the funds at the expense of PyMC and ArviZ since we are all on the same team. Towards the end of the NASA effort it was clear that 10 or so proposals were coming out of NumFOCUS--isn't AstroPy also on the same team? 

The NASA proposal was a solid month's work and I had the privilege of being able to hit it pretty much full time due to my boss's generosity (Andrew Gelman). I had a think about our competitive advantage just becuase I had the cycles to focus exclusively on getting a good pitch and then I had a thunk: resources beget more resources and here I am competing with organizations that I have no interest in 'defeating' in the funding game. 

In response to my 'thunk' I decided to create this repo with my metrics to hopefully help other NumFOCUS project for CZI. Sorry, they are in R but that is the language I am trying to learn but it is all pretty simple stuff, just a hassle to sort out queries, API access etc that take more time than I am willing to admit. 

I'm not accepting the zero-sum quality of scientific funding and I don't want to compete with my NumFOCUS neighbors. Maybe CZI allocates more funds because of all the compelling proposals and excellent metrics justifying the projects. 
...
For now I can be reached at fbb2116@columbia.edu or on NumFOCUS slack, @breckbaldwin. 

# Planned scripts

All the below scripts exist, I just need to clean them up a bit. Hopefully in by May 8, 2021 so people can work use them over the weekend. NumFOCUS wants solid drafts May 10.

+ CRAN downloads over time. 

# Complete scripts

## Subject distribution for Scopus.com

This requires a subscription to scopus.com which I got because of my Columbia University affiliation. I will be loosing these credentials soon but am happy to run queries for other projects for the remaining month. Email fbb2116@columbia.edu with likely search strings that might be mentioned in the citations of a research publication. Hopefully your project has a unique name that functions as a regid designator, i.e., use of the name is unique to your project which 'Stan' entirely fails at--see [https://statmodeling.stat.columbia.edu/2019/04/29/we-shouldntve-called-it-stan-i-shouldve-listened-to-bob-and-hadley/](https://statmodeling.stat.columbia.edu/2019/04/29/we-shouldntve-called-it-stan-i-shouldve-listened-to-bob-and-hadley/). 
